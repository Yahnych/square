...
3. Run `git clone https://github.com/DZ-Chike/1` command
4. Run `cd 1` command
...
13. To stop bots click the "Stop Bots" button and wait 3 seconds for process to close you will see a countdown there
...
15. Always make sure you wait the 3 seconds for process to close or you are gonna get captcha on the VPS ip
